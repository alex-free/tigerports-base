...
* Redo mprsyncup script.
* Compile fixes for tiger ports base on linux.

* [TigerPorts-1.1.3.tar.bz2](http://tigerports.com/macports/distfiles/MacPorts/TigerPorts-1.1.3.tar.bz2) _bzip2 release tarball ([verification signature](http://tigerports.com/macports/distfiles/MacPorts/TigerPorts-1.1.3.tar.bz2.sig))_

* [TigerPorts-1.1.3.tar.gz](http://tigerports.com/macports/distfiles/MacPorts/TigerPorts-1.1.3.tar.gz) _gzip release tarball ([verification signature](http://tigerports.com/macports/distfiles/MacPorts/TigerPorts-1.1.3.tar.gz.sig))_

* [TigerPorts-1.1.3.chk.txt](http://tigerports.com/macports/distfiles/MacPorts/TigerPorts-1.1.3.chk.txt) _cryptographic checksum manifest to verify the integrity of TigerPorts downloads_
